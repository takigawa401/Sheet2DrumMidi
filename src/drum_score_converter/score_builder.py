...
_INSTRUMENT_LABELS: Final[dict[str, DrumInstrument]] = {
    ...
    "hi hat": DrumInstrument.CLOSED_HI_HAT,
    "hi hat (closed)": DrumInstrument.CLOSED_HI_HAT,
    "hi hat (closed, with choke)": DrumInstrument.CLOSED_HI_HAT,
    "mute hi hat": DrumInstrument.CLOSED_HI_HAT,
    "muted hi hat": DrumInstrument.CLOSED_HI_HAT,
    "hi hat (muted)": DrumInstrument.CLOSED_HI_HAT,
    ...
    "ride cup": DrumInstrument.RIDE,
    "cup": DrumInstrument.RIDE,
    "crash": DrumInstrument.CRASH,
    "crash cymbal": DrumInstrument.CRASH,
    "high tom": DrumInstrument.HIGH_TOM,
    "hi tom": DrumInstrument.HIGH_TOM,
    "tom 1": DrumInstrument.HIGH_TOM,
    "mid tom": DrumInstrument.MID_TOM,
    "middle tom": DrumInstrument.MID_TOM,
    "medium tom": DrumInstrument.MID_TOM,
    "tom 2": DrumInstrument.MID_TOM,
    "floor tom": DrumInstrument.FLOOR_TOM,
    "low tom": DrumInstrument.FLOOR_TOM,
    "tom 3": DrumInstrument.FLOOR_TOM,
}
